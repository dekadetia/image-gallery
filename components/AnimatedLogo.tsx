...
<g clipPath={`url(#${idPrefix}_clip_letter_1)`}><g id="letter_1" className="letter-base">
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_2)`}><g id="letter_2" className="letter-base">
<g style={ { isolation: "isolate" } }>
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_3)`}><g id="letter_3" className="letter-base">
<g style={ { isolation: "isolate" } }>
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_4)`}><g id="letter_4" className="letter-base">
<g style={ { isolation: "isolate" } }>
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_5)`}><g id="letter_5" className="letter-base">
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_6)`}><g id="letter_6" className="letter-base">
<g style={ { isolation: "isolate" } }>
<path d="m166.8,183.6c0-3.8-.1-4-2.5-4h-5.1c-8.4,0-10.8,1-14.2,8.4-.6.5-2.6.3-2.9-.6,1.5-4.9,2.9-10.6,3.6-13.8.2-.3.5-.4,1-.4.4,0,.7.1.9.4.5,2.3,1.7,2.4,7.9,2.4h37.2c4.5,0,5.8-.3,6.9-2.4.4-.2.7-.4,1.1-.4.5,0,1,.2,1.2.5-.9,3.7-1.6,11.6-1.4,14.5-.5.7-2,.9-2.8.3-1.2-7.1-2.9-8.8-12.7-8.8h-5.2c-2.4,0-2.5.2-2.5,4v39.3c0,9.7.8,9.9,5.1,10.4l3.3.4c.6.6.5,2.3-.2,2.6-5.3-.2-9.4-.3-13.4-.3s-8.3.1-14.1.3c-.7-.4-.8-2.2-.2-2.6l3.8-.5c4.3-.5,5.1-.6,5.1-10.3v-39.4h.1Z" style={ { fill: "#59b94f", strokewidth: 0.0 } } />
</g>
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_7)`}><g id="letter_7" className="letter-base">
<g style={ { isolation: "isolate" } }>
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_8)`}><g id="letter_8" className="letter-base">
<g style={ { isolation: "isolate" } }>
