...
export default function AnimatedLogo() {
  ...
  const isInitialAlt =
    ...
    sessionStorage.getItem('logoState') === 'alt'
  ...
  useEffect(() => {
    ...
    const applyInitialState = () => {
      for (let i = 1; i <= 8; i++) {
        ...
        gsap.set(base, { autoAlpha: toggled ? 0 : 1, clearProps: 'all' })
        gsap.set(alt, { autoAlpha: toggled ? 1 : 0, clearProps: 'all' })
      }
    }
    ...
    logo.addEventListener('pointerup', (e) => {
      ...
      if (longPressed && e.pointerType === 'touch') e.preventDefault()
    })
    ...
    return () => {
      ...
      logo.removeEventListener('pointerdown', () => {})
      logo.removeEventListener('pointerup', () => {})
...
<g clipPath={`url(#${idPrefix}_clip_letter_1)`}><g id="letter_1"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_2)`}><g id="letter_2"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_3)`}><g id="letter_3"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_4)`}><g id="letter_4"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_5)`}><g id="letter_5"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_6)`}><g id="letter_6"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_7)`}><g id="letter_7"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_8)`}><g id="letter_8"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
...
<g clipPath={`url(#${idPrefix}_clip_letter_1)`}><g id="letter_9"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
<path d="m37,46.5c0-8.7-.1-9.8-4.8-10.3l-2.6-.3c-.7-.6-.7-2.1.1-2.6,4.5-.4,11.8-.8,22.8-.8,8.4,0,15.1.7,19.6,3.1,4.6,2.5,7,6.1,7,11.8,0,5.4-4.3,9.5-11.3,11.6-.4.1-.6.4-.6.5,0,.2.2.4.8.5,7.6,1.1,16.1,5.6,16.1,15.8,0,4.2-1.5,8.7-6.1,12.1-4.7,3.6-11.3,5.1-22.7,5.1-4.4,0-8.6-.3-12.4-.3-4.4,0-9.1.1-13.5.3-.8-.4-.9-2-.2-2.6l2.2-.3c4.7-.5,5.6-.8,5.6-10.5v-33.1Zm11.6,10c0,2.4.3,2.5,4.3,2.5,9.4,0,13.7-3.4,13.7-11.6s-6.5-11.2-12.7-11.2c-5,0-5.3.2-5.3,3.8v16.5Zm0,21.4c0,8.3,1,11.7,9.7,11.7,6.9,0,13-4.1,13-12.2,0-9.4-7-14.9-18.1-14.9-4.4,0-4.6.5-4.6,2.4,0,0,0,13,0,13Z" style={ { fill: "#e43f25", strokewidth: 0.0 } } />
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_2)`}><g id="letter_10"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_3)`}><g id="letter_11"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_4)`}><g id="letter_12"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_5)`}><g id="letter_13"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_6)`}><g id="letter_14"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
<path d="m169,220.6c0,4.6.2,7.9,1.6,9.5,1.1,1.3,2.6,2,9.9,2,10.2,0,11.7-.5,15.9-9.9.9-.5,2.4-.2,2.9.6-.7,3.9-2.8,10.9-3.9,13.4-3.9-.2-11.8-.3-22.1-.3h-9.6c-4.7,0-9.3.1-13.2.3-.7-.4-1-2.2-.2-2.7l2.8-.5c4.3-.7,5.2-.8,5.2-10.4v-34.3c0-9.6-.8-9.9-5.2-10.5l-2.6-.4c-.6-.5-.6-2.3.2-2.7,4.6.2,8.8.3,13,.3s8.2-.1,12.3-.3c.8.4.9,2.2.2,2.7l-2,.4c-4.3.7-5.2.9-5.2,10.5v32.3h0Z" style={ { fill: "#59b94f", strokewidth: 0.0 } } />
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_7)`}><g id="letter_15"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
...
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_8)`}><g id="letter_16"     style={{
      visibility: isInitialAlt ? 'hidden' : 'visible',
      opacity: isInitialAlt ? 0 : 1
    }}
  >
