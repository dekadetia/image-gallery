...
<path d="M33.7,36.1h23.3c10.9,0,24.5,2.1,24.5,16.4s-2.7,10-6.9,12.9c5,2.2,10.7,6.4,10.7,16.7s-7.7,17.2-19,17.2h-32.8l.2-63.2Z" style={ { fill: "#e43f25", strokewidth: 0.0 } } />
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_2)`}><g id="letter_10" style={{ display: isInitialAlt ? 'inline' : 'none' }}>
<path d="M150.6,36.1h18.2v34.8h21.1v28.3h-39.3v-63.2Z" style={ { fill: "#d2c52a", strokewidth: 0.0 } } />
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_3)`}><g id="letter_11" style={{ display: isInitialAlt ? 'inline' : 'none' }}>
<g style={ { isolation: "isolate" } }>
<path d="M257.5,35.5l34.3,20.7v-19h19.6v63.2h-54l.2-64.8Z" style={ { fill: "#4bb9ea", strokewidth: 0.0 } } />
</g>
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_4)`}><g id="letter_12" style={{ display: isInitialAlt ? 'inline' : 'none' }}>
<g style={ { isolation: "isolate" } }>
<path d="M363.8,36.1h28.2c16.8,0,28.9,17,28.9,32.3s-13.4,30.8-30.5,30.8h-26.5l-.2-63.2Z" style={ { fill: "#6a3e97", strokewidth: 0.0 } } />
</g>
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_5)`}><g id="letter_13" style={{ display: isInitialAlt ? 'inline' : 'none' }}>
<path d="M24.9,200.5c0-18.1,13.9-33.5,32.1-33.5s24.3,6.2,29.2,18.4l-24.3,14.7h28.1v33.1s-11.6-8.8-11.7-8.8c-6,4.9-13,8.6-21.3,8.6-18.4,0-32-15.3-32-32.4Z" style={ { fill: "#f47f20", strokewidth: 0.0 } } />
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_6)`}><g id="letter_14" style={{ display: isInitialAlt ? 'inline' : 'none' }}>
<path d="M153.7,168.3h18.2v34.8h21.1v28.3h-39.3v-63.2Z" style={ { fill: "#59b94f", strokewidth: 0.0 } } />
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_7)`}><g id="letter_15" style={{ display: isInitialAlt ? 'inline' : 'none' }}>
<g style={ { isolation: "isolate" } }>
<path d="M270.6,206.8c-6.1-5.4-8.6-10.4-8.6-18,0-12.1,9.9-21.1,22-21.1s17.7,4.1,20.5,13l-9.9,10.1c8.6,4.4,12.6,12.7,12.6,21.6,0,12.8-10.5,22.6-23.6,22.6s-20.5-7.6-22.6-18.2l9.6-10.1Z" style={ { fill: "#1c6bb4", strokewidth: 0.0 } } />
</g>
</g></g><g clipPath={`url(#${idPrefix}_clip_letter_8)`}><g id="letter_16" style={{ display: isInitialAlt ? 'inline' : 'none' }}>
<g style={ { isolation: "isolate" } }>
<path d="M378.3,205.8c-6.1-5.4-8.6-10.4-8.6-18,0-12.1,9.9-21.1,22-21.1s17.7,4.1,20.5,13l-9.9,10.1c8.6,4.4,12.6,12.7,12.6,21.6,0,12.8-10.5,22.6-23.6,22.6s-20.5-7.6-22.6-18.2l9.6-10.1Z" style={ { fill: "#d35589", strokewidth: 0.0 } } />
</g>
</g></g>
</svg>
  );
