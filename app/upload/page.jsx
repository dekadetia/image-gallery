  ...
  return !userIsLogged ? (
    ...
    <>
      ...
      <div className="w-full p-6">
        <form
          onSubmit={checkState}
          className="flex flex-col py-5 px-4 rounded-lg w-1/3 border border-solid border-white mx-auto"
        >
          ...
          <input
            ...
            className="block w-full text-sm border rounded-lg cursor-pointer text-gray-400 focus:outline-none bg-gray-700 border-gray-600 placeholder-gray-400 mb-6"
            id="file_input"
            type="file"
          />
          <button
            ...
            type="submit"
            className="bg-white text-black transition-all duration-300 hover:opacity-90 py-2 disabled:bg-gray-200 disabled:cursor-not-allowed"
          >
            Upload
          </button>
        </form>
              ...
              <div className="p-4 md:p-5 text-center">
                <div className="flex flex-col py-5 px-4 rounded-lg text-black">
                  ...
                  <button
                    ...
                    className="bg-white text-black my-4 transition-all duration-300 hover:opacity-90 py-2 bg-gray-200"
                  >
                    Update
                  </button>
                  <button
