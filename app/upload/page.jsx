...
export default function Page() {
    ...
    const checkState = async (e) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/firebase/create`, {
                method: "POST",
                body: formData,
            });
    ...
    return !userIsLogged ? (
        ...
        <>
            ...
            <div className="w-full p-6">
                <form onSubmit={checkState} className="py-5 px-4 rounded-lg w-1/3 border border-solid border-white mx-auto">
