...
export default function Page() {
  ...
  const handleImageClick =
    imageId => {
      ...
      /*
        WEBM LIGHTBOX WARMUP

        LazyWebm remains a grid-only optimization.

        Static images open immediately.

        For WebMs, preload the clicked source in a temporary
        video element and only open YARL once the browser has
        enough data to render the first frame. This keeps the
        lightbox from visibly reflowing while the video starts.
      */
      ...
      /*
        If the warmup fails for any reason, still open the
        lightbox rather than making the tile unresponsive.
      */
